...
date: 2026-06-23T00:00:00.000-08:00
toc: true
---
...
* 🕸 [IBM UML Basics Series](https://developer.ibm.com/series/uml-basics/)
* 🕸 [Practical UML](https://web.archive.org/web/20190220010601/http://edn.embarcadero.com/article/31863)

## Code Styling Guides

* 📘 [Clean Code](https://a.co/d/07De3uVC) ($)
...
* 📕 [Learn Git in a Month of Lunches](https://a.co/d/0gy6wnq8) ($)
...
| -------------------------------------------------------------------- | ----------------------------------- |
| [ChatGPT](https://chatgpt.com/)                                      | AI coding assistant                 |
...
| [Excalidraw](https://excalidraw.com/)                                | Quick whiteboard diagramming        |
...
| [Upcase](https://thoughtbot.com/upcase/vim)                          | Learning Vim                        |
| [Valgrind](http://valgrind.org/docs/manual/quick-start.html)         | Patching C memory leaks             |
| [Vim Adventures](https://vim-adventures.com/)                        | Learning Vim interactively          |
| [Vim Bootstrap](https://vim-bootstrap.com)                           | Making Vim more user friendly       |

## Practice Coding Challenges

* 📕 [Cracking the Coding Interview](https://a.co/d/0daQhVHX) ($)
* 📘 Elements of Programming Interviews in [Python](https://a.co/d/05pKywuY) ($)
